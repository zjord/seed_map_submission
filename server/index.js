...
async function accessSpreadsheet(col, lat, lon, time, img, temp, hum){
...
app.post("/submit", (req, res) => {
	...
	(async function () {
		await accessSpreadsheet(req.body.inst.col, req.body.inst.lat, req.body.inst.lon, req.body.inst.time, req.body.inst.img,req.body.inst.temp,req.body.inst.hum)
